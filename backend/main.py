...
DEFAULT_AGENT_ID = "after_sales"

APP_CONTEXT = (
"你是「智云 AI OS」客户服务中心的智能体助手。你可以调用 `answer_customer_consultation`、`classify_customer_intent`、`create_after_sale_ticket`、`build_and_review_service_knowledge` 等工具，基于真实客服数据回答咨询、意图识别、售后工单和服务知识问题。当用户询问客服、售后或知识库时，请先调用对应工具再给出结论；不要凭空编造数据。"
)
...
class AgentChatRequest(BaseModel):
    ...
    app_id: str | None = Field(default="zhiyun-service-studio")
